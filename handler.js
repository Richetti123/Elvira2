...
//this.reply(m.chat, `🐈 𝙉𝙊 𝙏𝙄𝙀𝙉𝙀 𝙀𝙇𝙑𝙄𝙍𝘼𝘾𝙊𝙄𝙉𝙎`, m)
this.sendMessage(m.chat, {text: `🐈 𝙉𝙊 𝙏𝙄𝙀𝙉𝙀 𝙀𝙇𝙑𝙄𝙍𝘼𝘾𝙊𝙄𝙉𝙎`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: wm, previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
continue     
}
...
if (m.money)
m.reply(+m.money + ' 𝙀𝙇𝙑𝙄𝙍𝘼𝘾𝙊𝙄𝙉𝙎 🐱 𝑮𝑨𝑺𝑻𝑨𝑫𝑶(𝑺)')  
break
}}} catch (e) {
console.error(e)
} finally {
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, 'ElviraBot ' + gt + ' ', '@vsebas.y'].getRandom(), thumbnail: gataImg, sourceUrl: accountsgb }}}}, tg)
